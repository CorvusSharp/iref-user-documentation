# ОБУЧЕНИЕ iRev — операционная работа (строго по транскрипту)

Это конспект «живого» обучения оператора: всё показывается в интерфейсе, без презентаций, с кейсами и ошибками. Цель — научить делать ежедневные операции.

## План занятия (как озвучено в начале)
